...
{
    public class EfDestinationRepository : GenericRepository<Destination>, IDestinationRepository
    {
        public EfDestinationRepository(DbContext context) : base(context)
        {
        }
    }
}
